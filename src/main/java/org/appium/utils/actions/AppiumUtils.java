package org.appium.utils.actions;
...
public class AppiumUtils {
    ...
    protected Properties getPropertiesData() throws IOException {
        ...
        FileInputStream input = new FileInputStream(System.getProperty("user.dir")+ "/src/main/java/org/appium/resources/data.properties");
